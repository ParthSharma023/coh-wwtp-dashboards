...
PLANT_RAIN_CONFIG = {
    "0400": ("69th_street",              "69th Street WWTP",              "69th Street",       2220, "Buffalo Bayou @ Milam Street"),
    "0006": ("almeda_sims",              "Almeda Sims WWTP",              "Almeda Sims",        370, "Sims Bayou @ SH 288"),
    "0242": ("beltway",                  "Beltway WWTP",                  "Beltway",            470, "Brays Bayou @ Belle Park Drive"),
    "0244": ("cedar_bayou",              "Cedar Bayou WWTP",              "Cedar Bayou",        740, "Lake Houston @ FM 1960"),
    ...
    "0059": ("easthaven",                "Easthaven WWTP",                "Easthaven",          340, "Sims Bayou @ Telephone Road"),
    "0083": ("fwsd_23",                  "F.W.S.D. #23 WWTP",             "FWSD #23",          1675, "Halls Bayou @ Tidwell Road"),
    "0565": ("forest_cove",              "Forest Cove WWTP",              "Forest Cove",        760, "San Jacinto River @ US 59"),
    ...
    "0268": ("imperial_valley",          "Imperial Valley WWTP",          "Imperial Valley",   1695, "P138 @ Aldine Westfield Road"),
    "0238": ("intercontinental_airport", "Intercontinental Airport WWTP", "Intercontinental",  1645, "Greens Bayou @ Beltway 8"),
    ...
    "0252": ("northbelt",                "Northbelt WWTP",                "Northbelt",         1650, "Garners Bayou @ Rankin Road"),
    ...
    "0145": ("northwest",                "Northwest WWTP",                "Northwest",          585, "Vogel Creek @ Victory Drive"),
    "0245": ("park_ten",                 "Park Ten WWTP",                 "Park Ten",          2110, "Addicks Dam"),
    "0171": ("sagemont",                 "Sagemont WWTP",                 "Sagemont",           160, "Beamer Ditch @ Hughes Road"),
    "0183": ("sims_bayou",               "Sims Bayou WWTP",               "Sims Bayou",         410, "Brays Bayou @ Lawndale Street"),
    "0283": ("sims_bayou_south",         "Sims Bayou-South WWTP",         "Sims Bayou",         410, "Brays Bayou @ Lawndale Street"),
    "0189": ("southeast",                "Southeast WWTP",                "Southeast",          175, "Clear Creek @ Pearland Pkwy"),
    "0190": ("southwest",                "Southwest WWTP",                "Southwest",          440, "Brays Bayou @ Rice Avenue"),
    ...
    "0286": ("upper_brays",              "Upper Brays WWTP",              "Upper Brays",       2290, "Buffalo Bayou @ Dairy Ashford Road"),
    ...
    "0469": ("willowbrook",              "Willowbrook WWTP",              "Willowbrook",       1670, "Greens Bayou @ Cutten Road"),
}
